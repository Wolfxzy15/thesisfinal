...
$selected_barangay = isset($_GET['barangay_filter']) ? mysqli_real_escape_string($conn, $_GET['barangay_filter']) : '';
                        ...
                        if ($result) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm" onclick="window.location.href=\'family_details.php?family_id=' . $family_id . '\'">View Family</button>
                                    </td>
                                </tr>';
                            }
                        }
